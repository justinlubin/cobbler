...
(** [search max_iterations grow prune is_correct] performs an enumerative search
    ...
    The search is parameterized by how to grow the search space ([grow]), how to
    prune observationally equivalent terms ([prune]), the notion of satisfaction
    ([is_correct]), and the maximum number of times to grow the search space
    [max_iterations]. *)
val search
  :  max_iterations:int
  -> grow:('e list -> 'e list)
